...
func main() {
	...
	// Size Test
	// fmt.Println("Size of Blockchain:  ", unsafe.Sizeof(net.Blockchain))
	...
	for {
		...
		newBlock := generateBlock(net.Blockchain.Blocks[len(net.Blockchain.Blocks)-1], input, net.Address, time.Time{})
