...
func main() {
	...
	for {
		...
		newTransaction := generateTransaction(net.Tangle.Transactions[len(net.Tangle.Transactions)-1], input, net.Address)
...
func generateTransaction(lastTransaction network.Transaction, Operation string, address string) network.Transaction {
